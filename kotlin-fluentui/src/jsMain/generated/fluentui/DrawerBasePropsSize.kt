...
@seskar.js.JsVirtual
sealed external interface DrawerBasePropsSize {
    companion object {
        @seskar.js.JsValue("small")
        val small: DrawerBasePropsSize

        @seskar.js.JsValue("medium")
        val medium: DrawerBasePropsSize

        @seskar.js.JsValue("large")
        val large: DrawerBasePropsSize

        @seskar.js.JsValue("full")
        val full: DrawerBasePropsSize
    }
}
