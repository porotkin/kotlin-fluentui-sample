...
sealed external interface CardContextValueSelectableA11yProps {
    var referenceId: String?
    var setReferenceId: (referenceId: String) -> Unit
    var referenceLabel: String?
    var setReferenceLabel: (referenceLabel: String) -> Unit
}
