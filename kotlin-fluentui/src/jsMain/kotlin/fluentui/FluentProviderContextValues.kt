...
sealed external interface FluentProviderContextValues : FluentProviderState {
    var provider: dynamic
    override var themeClassName: dynamic
    var textDirection: dynamic
    var iconDirection: dynamic
    var tooltip: dynamic
}
