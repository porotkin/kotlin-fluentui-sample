...
sealed external interface FluentProviderState : FluentProviderSlots, FluentProviderProps,
    Required<FluentProviderProps> {
    override var theme: dynamic
    var themeClassName: String

    /**
     * Props used to render SSR theme variables style element
     */
    var serverStyleProps: Temp120
}
