...
setMetadataFor(AbstractMutableList, 'AbstractMutableList', classMeta, VOID, [AbstractMutableCollection, Collection, List]);
setMetadataFor(Set, 'Set', interfaceMeta, VOID, [Collection]);
setMetadataFor(AbstractMutableSet, 'AbstractMutableSet', classMeta, VOID, [AbstractMutableCollection, Collection, Set]);
setMetadataFor(Companion, 'Companion', objectMeta);
setMetadataFor(ArrayList, 'ArrayList', classMeta, VOID, [AbstractMutableList, Collection, List], ArrayList.w1);
setMetadataFor(HashSet, 'HashSet', classMeta, VOID, [AbstractMutableSet, Collection, Set], HashSet.f2);
...
setMetadataFor(LinkedHashSet, 'LinkedHashSet', classMeta, VOID, [HashSet, Collection, Set], LinkedHashSet.u4);
